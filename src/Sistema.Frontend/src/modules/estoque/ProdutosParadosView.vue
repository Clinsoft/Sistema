...
// Resíduo sem loja: saldo do cadastro que não está atribuído a nenhuma loja
// (ex.: saldo inicial importado sem movimentação). Assim as colunas fecham com o Total.
...
const headers = computed(() => [
  ...
  ...(temSemLoja.value ? [{ title: 'Sem loja', key: 'semLoja', align: 'end' as const, sortable: false, width: 90 }] : []),
