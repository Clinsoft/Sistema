...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/estoque/curva-abc', redirect: '/estoque/relatorios?aba=curva-abc' },
    { path: '/estoque/negativos', redirect: '/estoque/relatorios?aba=negativos' },
    { path: '/estoque/sugestao-compra', component: () => import('@/modules/estoque/SugestaoCompraView.vue'),
      meta: { titulo: 'Sugestão de Compra' } },
    { path: '/estoque/produtos-parados', redirect: '/estoque/relatorios?aba=produtos-parados' },
    ...
    { path: '/estoque/perdas-validade', redirect: '/estoque/relatorios?aba=perdas-validade' },
    ...
    { path: '/tutoriais', component: () => import('@/modules/ajuda/TutoriaisView.vue'),
      meta: { titulo: 'Tutoriais' } },
    ...
    { path: '/financeiro/dre', component: () => import('@/modules/financeiro/DreHubView.vue'),
      meta: { titulo: 'DRE — Demonstrativo de Resultados' } },
    // Rotas antigas → abas do hub de DRE (mantém links existentes funcionando)
    { path: '/financeiro/dre-mensal', redirect: '/financeiro/dre?aba=mensal' },
    { path: '/financeiro/dre-lojas', redirect: '/financeiro/dre?aba=lojas' },
    { path: '/desempenho/premiacao', component: () => import('@/modules/desempenho/PremiacaoView.vue'),
...
const ROTAS_ATENDENTE = [
  ...
  '/estoque/relatorios',   // hub (atendente só vê a aba Perdas por Validade)
  '/whatsapp',
