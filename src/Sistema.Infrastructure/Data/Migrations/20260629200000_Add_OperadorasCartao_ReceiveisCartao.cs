...
{
    /// <inheritdoc />
    public partial class Add_OperadorasCartao_ReceiveisCartao : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_OperadorasCartao", x => x.Id));
        ...
        {
            migrationBuilder.DropTable(name: "ReceiveisCartao");
            migrationBuilder.DropTable(name: "OperadorasCartao");
        }
    }
}
